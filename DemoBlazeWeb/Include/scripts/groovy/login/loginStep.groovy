...
class loginStep {
	...
	def enterCredentials(String username, String password) {
		WebUI.setText(findTestObject('Object Repository/login-logout/Page_STORE/input_Username_loginusername'), username)
		WebUI.setEncryptedText(findTestObject('Object Repository/login-logout/Page_STORE/input_Password_loginpassword'), password)
	}
